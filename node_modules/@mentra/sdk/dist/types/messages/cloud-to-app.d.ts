...
import type { LocationUpdate, CalendarEvent, RtmpStreamStatus, PhotoResponse, RgbLedControlResponse } from "./glasses-to-cloud";
 ...
 */
export type CloudToAppMessage = AppConnectionAck | AppConnectionError | StandardConnectionError | DataStream | AppStopped | SettingsUpdate | CapabilitiesUpdate | DeviceStateUpdate | TranscriptionData | TranslationData | AudioChunk | LocationUpdate | CalendarEvent | PhotoResponse | DashboardModeChanged | DashboardAlwaysOnChanged | CustomMessage | ManagedStreamStatus | StreamStatusCheckResponse | MentraosSettingsUpdate | AppMessageReceived | AppUserJoined | AppUserLeft | AppRoomUpdated | AppDirectMessageResponse | RtmpStreamStatus | PhotoResponse | RgbLedControlResponse | PermissionError | AudioPlayResponse;
...
export declare function isDeviceStateUpdate(message: CloudToAppMessage): message is DeviceStateUpdate;
...
export declare function isRgbLedControlResponse(message: CloudToAppMessage): message is RgbLedControlResponse;
